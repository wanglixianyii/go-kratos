...
const (
	User_Register_FullMethodName = "/api.admin.v1.User/Register"
	User_Login_FullMethodName    = "/api.admin.v1.User/Login"
	User_Captcha_FullMethodName  = "/api.admin.v1.User/Captcha"
...
func (c *userClient) Captcha(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CaptchaResp, error) {
	out := new(CaptchaResp)
	err := c.cc.Invoke(ctx, User_Captcha_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) UserInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UserInfoResp, error) {
...
func (UnimplementedUserServer) Captcha(context.Context, *emptypb.Empty) (*CaptchaResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Captcha not implemented")
}
func (UnimplementedUserServer) UserInfo(context.Context, *emptypb.Empty) (*UserInfoResp, error) {
...
func _User_UserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UserInfo(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/user-api/v1/user.proto",
}
