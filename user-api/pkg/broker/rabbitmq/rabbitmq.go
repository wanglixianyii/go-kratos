...
func (b *rabbitBroker) Options() broker2.Options {
	return b.opts
}
...
func (b *rabbitBroker) Init(opts ...broker2.Option) error {
	b.opts.Apply(opts...)
...
func (b *rabbitBroker) Publish(routingKey string, msg broker2.Any, opts ...broker2.PublishOption) error {
...
func (b *rabbitBroker) publish(routingKey string, buf []byte, opts ...broker2.PublishOption) error {
	if b.conn == nil {
		return errors.New("connection is nil")
	}
...
func (b *rabbitBroker) Subscribe(routingKey string, handler broker2.Handler, binder broker2.Binder, opts ...broker2.SubscribeOption) (broker2.Subscriber, error) {
	if b.conn == nil {
	...
	fn := func(msg amqp.Delivery) {
		...
		if err := broker2.Unmarshal(b.opts.Codec, msg.Body, &m.Body); err != nil {
			p.err = err
			log.Error(err)
		}
