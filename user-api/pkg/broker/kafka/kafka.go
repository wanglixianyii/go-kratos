...
func (b *kafkaBroker) Options() broker2.Options {
	return b.opts
}

func (b *kafkaBroker) Init(opts ...broker2.Option) error {
	b.opts.Apply(opts...)
...
func (b *kafkaBroker) Publish(topic string, msg broker2.Any, opts ...broker2.PublishOption) error {
...
func (b *kafkaBroker) publishMultipleWriter(topic string, buf []byte, opts ...broker2.PublishOption) error {
...
func (b *kafkaBroker) publishOneWriter(topic string, buf []byte, opts ...broker2.PublishOption) error {
	options := broker2.PublishOptions{
		Context: context.Background(),
	}
	for _, o := range opts {
...
func (b *kafkaBroker) Subscribe(topic string, handler broker2.Handler, binder broker2.Binder, opts ...broker2.SubscribeOption) (broker2.Subscriber, error) {
	...
	go func() {
		...
		for {
			...
			default:
				...
				if err := broker2.Unmarshal(b.opts.Codec, msg.Value, &m.Body); err != nil {
					p.err = err
