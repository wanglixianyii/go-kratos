...
func newAliyunHttpBroker(options broker2.Options) broker2.Broker {
	return &aliyunBroker{
...
func (r *aliyunBroker) Options() broker2.Options {
	return r.opts
}

func (r *aliyunBroker) Init(opts ...broker2.Option) error {
	r.opts.Apply(opts...)
...
func (r *aliyunBroker) Publish(topic string, msg broker2.Any, opts ...broker2.PublishOption) error {
...
func (r *aliyunBroker) publish(topic string, msg []byte, opts ...broker2.PublishOption) error {
...
func (r *aliyunBroker) Subscribe(topic string, handler broker2.Handler, binder broker2.Binder, opts ...broker2.SubscribeOption) (broker2.Subscriber, error) {
	if r.client == nil {
			...
			case resp := <-respChan:
				{
					...
					for _, msg := range resp.Messages {
						...
						if err := broker2.Unmarshal(r.opts.Codec, []byte(msg.MessageBody), &m.Body); err != nil {
							p.err = err
