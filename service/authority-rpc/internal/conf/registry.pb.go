...
var file_conf_registry_proto_rawDesc = []byte{
	...
	0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x42, 0x45, 0x5a, 0x43, 0x67, 0x69,
...
var file_conf_registry_proto_goTypes = []interface{}{
	(*Registry)(nil),            // 0: authority-rpc-api.conf.Registry
	(*Registry_Consul)(nil),     // 1: authority-rpc-api.conf.Registry.Consul
	(*Registry_Etcd)(nil),       // 2: authority-rpc-api.conf.Registry.Etcd
	(*Registry_Kubernetes)(nil), // 3: authority-rpc-api.conf.Registry.Kubernetes
}
var file_conf_registry_proto_depIdxs = []int32{
	1, // 0: authority-rpc-api.conf.Registry.consul:type_name -> authority-rpc-api.conf.Registry.Consul
	2, // 1: authority-rpc-api.conf.Registry.etcd:type_name -> authority-rpc-api.conf.Registry.Etcd
	3, // 2: authority-rpc-api.conf.Registry.kubernetes:type_name -> authority-rpc-api.conf.Registry.Kubernetes
