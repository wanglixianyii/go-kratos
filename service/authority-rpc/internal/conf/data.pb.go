...
var file_conf_data_proto_rawDesc = []byte{
	...
	0x0c, 0x77, 0x72, 0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x45, 0x5a,
	0x43, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x77, 0x61, 0x6e, 0x67,
	0x6c, 0x69, 0x78, 0x69, 0x61, 0x6e, 0x79, 0x69, 0x69, 0x2f, 0x67, 0x6f, 0x2d, 0x6b, 0x72, 0x61,
	0x74, 0x6f, 0x73, 0x2f, 0x72, 0x70, 0x63, 0x2d, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74,
...
var file_conf_data_proto_goTypes = []interface{}{
	(*Data)(nil),                // 0: authority-rpc-api.conf.Data
	(*Data_Database)(nil),       // 1: authority-rpc-api.conf.Data.Database
	(*Data_Redis)(nil),          // 2: authority-rpc-api.conf.Data.Redis
	(*durationpb.Duration)(nil), // 3: google.protobuf.Duration
}
var file_conf_data_proto_depIdxs = []int32{
	1, // 0: authority-rpc-api.conf.Data.database:type_name -> authority-rpc-api.conf.Data.Database
	2, // 1: authority-rpc-api.conf.Data.redis:type_name -> authority-rpc-api.conf.Data.Redis
	3, // 2: authority-rpc-api.conf.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	3, // 3: authority-rpc-api.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	3, // 4: authority-rpc-api.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
